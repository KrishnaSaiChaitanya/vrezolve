    ...
    <>
      <div className=" flex md:flex hidden sm:block">
        <div className="flex flex-col py-12 bg-white">
          <HomeHero />
          <div className="mt-10 max-w-full mx-auto bg-[#0033cc] h-[3px] w-full" />
          <div className="flex flex-col items-center bg-[#f2f5fc] px-10 py-12 w-full  max-md:px-5 max-md:max-w-full">
            <div className="flex  flex-col items-center mt-20 mb-20 max-w-full text-xl text-black w-[858px] max-md:mt-10">
          ...
          <div className="flex justify-center  items-center px-16 py-12 w-full text-xl text-blue-700 bg-[#f2f5fc] tracking-[2px] max-md:px-5 max-md:max-w-full">
