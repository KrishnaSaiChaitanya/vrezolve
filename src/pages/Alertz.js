    ...
    <>
      <div className="flex flex-col md:flex hidden sm:block">
        <div className="flex flex-col items-center py-12 bg-white">
          <AlertzHero />
          <div className="flex justify-center items-center self-stretch px-16 py-12 mt-4 w-full bg-blue-700 bg-opacity-10 max-md:px-5 max-md:max-w-full">
            <div className="justify-center mt-16 mb-12 max-w-full w-[1191px] max-md:my-10">
          ...
          <div className="mt-32 text-4xl font-bold text-center text-black leading-[60px] w-[593px] max-md:mt-10 max-md:max-w-full">
          ...
          <div className="mt-14 text-4xl font-bold text-center text-black leading-[60px] max-md:mt-10">
            Key features spotlight
          </div>{" "}
          <div className="justify-center flex mt-32 max-w-full w-[1040px] max-md:mt-10">
          ...
          <div className="justify-center mt-10 max-w-full flex  w-[1040px]">
            <div className="flex  gap-[200px]  max-md:flex-col max-md:gap-0 max-md:">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          <div className="justify-center mt-10 mb-[120px] max-w-full flex  w-[1030px]">
            <div className="flex  gap-[200px]  max-md:flex-col max-md:gap-0 max-md:">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-center px-5 py-5 w-full bg-white rounded-3xl shadow-md max-md:px-5 max-md:mt-10">
                  <img
          ...
          <CardsSection />
          <div className="justify-center mt-32 max-w-full w-[1200px] max-md:mt-10">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-center px-5 pt-3 text-xl leading-8 text-black max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="mt-12 text-4xl font-bold leading-[60px] max-md:mt-10 max-md:max-w-full">
          ...
          <div className="justify-center mt-32 max-w-full w-[1179px] max-md:mt-10">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <img
                  loading="lazy"
              ...
              <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-center px-5 text-xl leading-8 text-black max-md:mt-10 max-md:max-w-full">
                  <div className="flex flex-col justify-center p-3  leading-[150%] max-md:pr-5 max-md:max-w-full">
                    ...
                    <div className="mt-12 font-bold  text-4xl max-md:mt-10 max-md:max-w-full">
                      Dispute Resolution
                    </div>
                    <div className="mt-12 leading-8 max-md:mt-10 max-md:max-w-full">
                      <span className="font-bold">alert</span>{" "}
                      <span className=" font-black text-orange-500">Z</span>{" "}
                      <span className="">
          ...
          <div className="justify-center mt-32 max-w-full w-[1129px] max-md:mt-10">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-center px-5 text-xl text-black max-md:mt-10 max-md:max-w-full">
                  <div className="flex flex-col justify-center p-3 max-md:pr-5 max-md:max-w-full">
                    ...
                    <div className="mt-12  font-bold text-4xl leading-[60px] max-md:mt-10 max-md:max-w-full">
