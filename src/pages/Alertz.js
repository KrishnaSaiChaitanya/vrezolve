                  ...
                  <div className="flex gap-4 justify-between  leading-[60px] max-md:flex-wrap max-md:max-w-full">
                    <div className="flex flex-col flex-1 max-md:max-w-full">
                      ...
                      <div className="mt-9 tracking-wider leading-8 max-md:max-w-full">
                        ...
                        suspicious transactions, empowering them to take
                        immediate action. Our mission is to stay ahead of the
                        fraudsters, and we're proud to offer best-in-class
                        solutions that protect our clients from the ever-present
                        threat of fraud.
                      </div>
                    ...
                    <div className="flex flex-col flex-1 max-md:max-w-full">
                      <div className="flex flex-col px-5  max-md:max-w-full">
                        ...
                        <div className="mt-9 tracking-wider leading-8 max-md:max-w-full">
                          ...
                          <span className="">
                            has a platform that serves as a communication
                            bridge, ensuring merchants and cardholders can
                            address issues promptly. Experience faster dispute
                            resolution and eliminate the need for chargebacks
                            with direct issue resolution.
                          </span>
                        </div>
                      </div>
                      ...
                      <ul>
                        <li className="flex flex-row">
                          ...
                          <p>
                            ...
                            : Minimize the necessity of filing chargebacks
                            through direct issue resolution.
                          </p>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="flex flex-col grow text-xl leading-8 text-black max-md:mt-6 max-md:max-w-full">
                  <div className="flex gap-4 justify-between  leading-[60px] max-md:flex-wrap max-md:max-w-full">
                    <div className="flex flex-col flex-1 max-md:max-w-full">
                      ...
                      <div className="mt-9 tracking-wider leading-8 max-md:max-w-full">
                        Preserving chargeback rights is integral to our
                        commitment to customer satisfaction and dispute
                        resolution. We understand the importance of providing
                        users with a reliable recourse in case of unresolved
                        issues. We empower users with a secure and effective
                        means to address disputes, reinforcing their confidence
                        in our commitment to a fair and transparent resolution
                        process.
                      </div>
                      <div className="mt-11 tracking-wide leading-8 max-md:mt-10 max-md:max-w-full w-[600px]">
                        <ul className="space-y-9">
